...
def iniciar_gui():
    ...
    # Itens já existentes
    menu_gerenciar.add_command(label="Estoque de Produtos", command=lambda: self.abrir_janela_estoque())
    menu_gerenciar.add_command(label="Formas de Pagamento", command=lambda: self.abrir_janela_pagamento())
